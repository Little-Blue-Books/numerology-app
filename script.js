...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderResults(data) {
        ...
        renderIntensityTable(data.intensityCounts);
     ...
     * ② Intensity Table
     */
    function renderIntensityTable(counts) {
    ...
    function renderPyramid(pinnacles) {
        ...
        container.innerHTML = `
            <svg viewBox="0 0 400 250" class="w-full h-full pyramid-svg">
                <!-- Pyramid Lines -->
                <path d="M200 20 L50 220 L350 220 Z" fill="none" stroke="rgba(0,0,0,0.05)" stroke-width="1" />
                <path d="M200 20 L125 120 L275 120 Z" fill="none" stroke="rgba(251,113,133,0.3)" stroke-width="2" />
                
                <!-- P3 (Top) -->
                <circle cx="200" cy="20" r="18" fill="rgba(251,113,133,0.1)" stroke="rgba(251,113,133,0.6)" />
                <text x="200" y="27" text-anchor="middle" class="pyramid-value">${pinnacles.p3}</text>
                <text x="200" y="-5" text-anchor="middle" class="pyramid-label">第3ピナクル</text>

                <!-- P1 (Mid Left) -->
                <circle cx="125" cy="120" r="18" fill="rgba(251,113,133,0.05)" stroke="rgba(251,113,133,0.4)" />
                <text x="125" y="127" text-anchor="middle" class="pyramid-value">${pinnacles.p1}</text>
                <text x="80" y="125" text-anchor="end" class="pyramid-label">第1</text>

                <!-- P2 (Mid Right) -->
                <circle cx="275" cy="120" r="18" fill="rgba(251,113,133,0.05)" stroke="rgba(251,113,133,0.4)" />
                <text x="275" y="127" text-anchor="middle" class="pyramid-value">${pinnacles.p2}</text>
                <text x="320" y="125" text-anchor="start" class="pyramid-label">第2</text>

                <!-- P4 (Bottom Center) -->
                <circle cx="200" cy="210" r="18" fill="rgba(251,113,133,0.1)" stroke="rgba(251,113,133,0.4)" />
                <text x="200" y="217" text-anchor="middle" class="pyramid-value">${pinnacles.p4}</text>
                <text x="200" y="245" text-anchor="middle" class="pyramid-label">第4ピナクル</text>
            </svg>
        `;
    }
});
